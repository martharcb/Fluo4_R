...
B4 = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/2019_12_4/B4.csv")
...
B4bkgd = read.csv("M:/Erik/Data/Calcium Imaging Analysis/Fura2 Images/2019_12_4/B4bkgd.csv")
...
Analysis = function(Agonists_information, Exposure_Information, Fluorescence_Information){
  ...
  dir.create("M:\\Erik\\Data\\Calcium Imaging Analysis\\Fura2 Images\\2019_12_4\\B4plots")
  for (i in seq_along(FLUO[,1:ncol(FLUO)])) {
    #tempname = paste("cell_",i,".png", sep="")
    outpath = file.path("M:\\Erik\\Data\\Calcium Imaging Analysis\\Fura2 Images\\2019_12_4\\B4plots", paste("cell_",i,".png", sep=""))
